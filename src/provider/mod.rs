...
pub trait MarketProviderFacade {
    ...
    fn scan(&self, criteria: DemandCriteria) 
        -> Result<(), ScanError>;

    fn subscribe(&self, offer: Offer) 
    ...
    fn create_proposal(&self, offer : Offer, demand : Demand) 
        -> Result<(), ProposalError>;

    fn approve_agreement(&self, agreement : Agreement) 
        -> Result<(), AgreementError>;

    fn reject_agreement(&self, agreement : Agreement)   
        -> Result<(), AgreementError>;
}
