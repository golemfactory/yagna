...
pub struct ValidationNegotiatorConfig {
    // #[structopt(long, default_values_t = vec!["golem.com.payment.chosen-platform"])]
...
pub struct CompositeNegotiatorConfig {
    #[structopt(flatten)]
    pub validation_config: ValidationNegotiatorConfig,
    #[structopt(flatten)]
