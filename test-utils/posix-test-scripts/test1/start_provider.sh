...
cargo run --bin ya-provider -- --activity-url http://127.0.0.1:6001/activity-api/v1/ --app-key ${APP_KEY} --market-url http://127.0.0.1:5001/market-api/v1/ --exe-unit-path ../../../exe-unit
