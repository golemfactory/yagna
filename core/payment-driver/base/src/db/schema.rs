...
table! {
    transaction (tx_id) {
        ...
        final_gas_price_exact -> Nullable<Text>,
        final_gas_used -> Nullable<Integer>,
        amount_base -> Nullable<Double>,
        amount_base_exact -> Nullable<Text>,
        amount_erc20 -> Nullable<Double>,
        amount_erc20_exact -> Nullable<Text>,
