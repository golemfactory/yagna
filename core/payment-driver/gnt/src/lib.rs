...
use ya_core_model::driver::{
    AccountMode, PaymentConfirmation, PaymentDetails, PaymentStatus,
};
use crate::ya_payment_driver::{utils, PaymentDriver, PaymentDriverError};

const BUS_ID = driver::BUS_ID_PREFIX.to_string() + "dummy";
