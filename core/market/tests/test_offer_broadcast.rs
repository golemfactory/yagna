...
//     let invalid_id = SubscriptionId::from_str("edb0016d9f8bafb54540da34f05a8d510de8114488f23916276bdead05509a53").unwrap();
...
//     mkt1.subscribe_demand(&client::sample_demand(), &identity1)
//         .await
//         .unwrap();
//     mkt2.subscribe_demand(&client::sample_demand(), &id2)
//         .await
