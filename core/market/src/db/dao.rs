...
pub mod sql_functions {
    ...
    diesel::define_sql_function! {
        fn datetime(timestring: sql_types::Text, modifier: sql_types::Text) -> sql_types::Timestamp;
    }
    diesel::define_sql_function! {
        #[sql_name = "coalesce"]
...
pub(crate) use agreement_events::same_reason;
pub use agreement_events::{AgreementEventsDao, TerminationNoticeOutcome};
