...
impl Proposal {
    ...
    pub fn new_provider(
        ...
        let proposal = DbProposal {
            id: proposal_id,
            // From Provider's perspective this is the first Proposal that ever existed.
            // Requestor has one proposal more (with id `demand_proposal.proposal_id`),
            // which was generated by the market.
            prev_proposal_id: None,
            issuer: IssuerType::Them,
            negotiation_id: negotiation.id.clone(),
