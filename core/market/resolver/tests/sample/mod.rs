...
pub static POC_DEMAND_PROPERTIES_JSON: &str = r#"
{
  ...
  "golem.srv.comp.wasm.task_package": "hash://sha3:38D951E2BD2408D95D8D5E5068A69C60C8238FA45DB8BC841DC0BD50:http://3.249.139.167:8000/rust-wasi-tutorial.zip"
}"#;
...
pub static POC_DEMAND_PROPERTIES_JSON_DEEP: &str = r#"
{
  "golem": {
    ...
    "srv.comp": {
      ...
      "wasm.task_package": "hash://sha3:38D951E2BD2408D95D8D5E5068A69C60C8238FA45DB8BC841DC0BD50:http://3.249.139.167:8000/rust-wasi-tutorial.zip"
    }
  }
}"#;
