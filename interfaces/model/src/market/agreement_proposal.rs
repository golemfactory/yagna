...
pub struct AgreementProposal {
    ...
    pub id: String,
    #[serde(rename = "demand")]
    pub demand: crate::market::Proposal,
    #[serde(rename = "offer")]
    pub offer: crate::market::Proposal,
}

impl AgreementProposal {
    pub fn new(id: String, demand: crate::market::Proposal, offer: crate::market::Proposal) -> AgreementProposal {
        AgreementProposal {
            id,
            demand,
            offer,
